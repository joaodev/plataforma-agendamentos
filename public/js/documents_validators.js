function validateCPF() {
    ...
    $("#document_1").attr('style', 'border: 1px solid green;');
    return true;
}
...
function validateCNPJ() {
    ...
    $("#document_2").attr('style', 'border: 1px solid green;');
    return true;
    
}

function validateCPFCart() {
    $("#cardCCC").removeAttr('style');

    let inputCPF = $("#cardCCC").val();
    let strCPF = inputCPF.replace('.', '').replace('.', '').replace('-', '');
    ...
    if (strCPF == "00000000000") {
        $("#cardCCC").val('').focus().attr('style', 'border: 1px solid red;');
        return false;
    } 
    ...
    $("#cardCCC").attr('style', 'border: 1px solid green;');
    return true;
}